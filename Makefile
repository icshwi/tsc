...
TSCLIB_SRCS := tsculib.c clilib.c tscextlib.c tstlib.c ponmboxlib.c \
	       	mtca4amclib.c mtca4rtmlib.c pca9539lib.c rsp1461lib.c \
	       	rdt1465lib.c rcc1466lib.c

ADCLIB_SRCS := adc3112lib.c fscope3112lib.c adc3110lib.c gscope3110lib.c
...
TSCMON_SRCS += tdma.c rsp1461.c rdt1465.c rcc1466.c gscope.c
